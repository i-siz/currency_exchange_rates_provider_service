 ...
 * Uses Spring Cache abstraction with Redis as the cache store.
 */
@Configuration
@EnableCaching
public class RedisConfig {
     ...
     * Sets default TTL and serialization for cache entries.
     */
    @Bean
    public CacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        RedisCacheConfiguration config = RedisCacheConfiguration.defaultCacheConfig()
                .entryTtl(Duration.ofHours(24)) // Cache exchange rates for 24 hours
                .serializeKeysWith(
